...
public class SettingsValues {
    ...
    public final float mBottomRowSideWidthScale;
    ...
    public final boolean mHideBottomSymbolKey;
    public final boolean mCommaNextToPeriod;
    ...
    public final boolean mCompletionBlend;
    ...
    public SettingsValues(final Context context, final SharedPreferences prefs, final Resources res,
        ...
        mLongpressBackspaceDeleteWordAcceleration = prefs.getInt(Settings.PREF_LONGPRESS_BACKSPACE_DELETE_WORD_ACCELERATION, Defaults.PREF_LONGPRESS_BACKSPACE_DELETE_WORD_ACCELERATION);
        ...
        mCompletionBlend = prefs.getBoolean(Settings.PREF_COMPLETION_BLEND, Defaults.PREF_COMPLETION_BLEND);
        ...
        mBottomRowSideWidthScale = Settings.readBottomRowSideWidthScale(prefs, isLandscape, isFolded);
        ...
        mHideBottomSymbolKey = prefs.getBoolean(Settings.PREF_HIDE_BOTTOM_SYMBOL_KEY, Defaults.PREF_HIDE_BOTTOM_SYMBOL_KEY);
        mCommaNextToPeriod = prefs.getBoolean(Settings.PREF_COMMA_NEXT_TO_PERIOD, Defaults.PREF_COMMA_NEXT_TO_PERIOD);
